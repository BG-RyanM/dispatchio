...
class SyncMessage(Message):
    ...
    def __init__(self,
                 ...
                 group_id: Union[str, int, None] = None,
                 content: Any = None):
        super().__init__(message_type=message_type, id=id, source_id=source_id, destination_id=destination_id,
    ...
    def make_copy(self):
        ...
        return SyncMessage(message_type=self.message_type, id=self.id, source_id=self.source_id,
...
class AsyncMessage(Message):
    ...
    def make_copy(self):
        # TODO: copying content
        return AsyncMessage(message_type=self.message_type, id=self.id, source_id=self.source_id,
                       destination_id=self.destination_id, group_id=self.group_id,
                            content=self.content, response_required=self.response_required,
                            is_response=self.is_response, is_blocking=self.is_blocking)
